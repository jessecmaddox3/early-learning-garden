    ...
    with tempfile.TemporaryDirectory(prefix='morphology-rls-') as root:
        ...
        try:
            ...
            for owner, profile in ((A, PA), (B, PB)):
                ...
                query(f"insert into learning_saves(profile_id,game_id,curriculum_id,format_version,snapshot,write_id,revision,updated_at) values ('{profile}','blend','test-v1',1,'{{\"streak\":2}}',gen_random_uuid(),999,'2000-01-01');", owner)
            ...
            query(f"insert into learning_saves(profile_id,game_id,curriculum_id,format_version,snapshot,write_id) values ('{PA}','blend','test-v1',1,'{{}}',gen_random_uuid());", role='anon', fails=True)
            ...
            query(f"insert into learning_saves(profile_id,game_id,curriculum_id,format_version,snapshot,write_id) values ('{PB}','blend','test-v1',1,'{{}}',gen_random_uuid());", A, fails=True)
